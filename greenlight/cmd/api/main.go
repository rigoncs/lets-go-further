...
func main() {
	...
	flag.StringVar(&cfg.smtp.username, "smtp-username", "0ac2db9c291cbb", "SMTP username")
	flag.StringVar(&cfg.smtp.password, "smtp-password", "ae57506f821b8d", "SMTP password")
